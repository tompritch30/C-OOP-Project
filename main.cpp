...
// testing the time class edge cases.
// 1: test seconds
// Time time3(1, 1, 55);
// Time time4(0, 0, 7);
// cout << "Original time3: " << time3 << ", time4: " << time4 << endl;
// time3.add(time4);
// cout << "After addition: " << time3 << "\n\n";


// 2: test minutes
// Time time5(1, 59, 1);
// Time time6(0, 2, 0);
// cout << "Original time5: " << time5 << ", time6: " << time6 << endl;
// time5.add(time6);
// cout << "After addition: " << time5 << "\n\n";

// 3: test hours
// Time time7(23, 1, 1);
// Time time8(2, 0, 0);
// cout << "Original time7: " << time7 << ", time8: " << time8 << endl;
// time7.add(time8);

	/* (a) initialise the time: */
	  
	Time timeZero(0, 0, 0);
	TrafficLight::setTheTime(timeZero);			
	// event (a) completed
